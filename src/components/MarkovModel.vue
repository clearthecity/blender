...
<button type='button' v-on:click='makeAuthorChain'>Chain</button>
<!-- input: adjust num_sentences -->

<div id='model-result'> {{ generatedText }} </div>
  ...
  export default {
    ...
    methods: {
      makeAuthorChain: function() {
        ...
        this.authorMarkov = new MarkovChain(text)
        this.blendedMarkov = this.authorMarkov.parse(this.inputText)
        this.generate()
      },
      generate: function() {
